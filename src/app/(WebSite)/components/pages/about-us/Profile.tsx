...
export default function Profile({name, role, children}: ProfileProp) {
  return (<Box>
    <ReactCompareSlider
        ...
        itemOne={<Image src={`/images/avatar/${name}-left.png`} alt={`${name} avatar`} width={500} height={500} priority style={{width: '100%', height: 'auto'}}/>}
        itemTwo={<Image src={`/images/avatar/${name}-right.png`} alt={`${name} avatar`} width={500} height={500} priority style={{width: '100%', height: 'auto'}}/>}/>
